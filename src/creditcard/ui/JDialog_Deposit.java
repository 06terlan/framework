...
public class JDialog_Deposit extends javax.swing.JDialog
{
	...
	public JDialog_Deposit(CardFrm cardFrm, Account account)
	{
		this.account = account;
		name = ((Custormer)account.getOwner()).getName();
	...
	{
        account.depositMoney(Double.parseDouble(JTextField_Deposit.getText()));
		cardFrm.updateTable();
        dispose();
	}
